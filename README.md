...
## Installation
Install <a href="https://www.tensorflow.org/install/pip">TensorFlow 1.X-GPU</a> for training models & <a href="https://pytorch.org/get-started/previous-versions/">Pytorch-CPU</a> for reading data. The code is runnable under TF1.9.0 GPU version, Pytorch 1.1.0 CPU version, and Python 3.6. There are also some dependencies for a few Python libraries for data processing and visualizations like `cv2`. It's highly recommended that you have access to GPUs.
